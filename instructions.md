...
INSTRUCTIONS
Repair the function ‘get_next_line’ in the file get_next_line.c. You may need
to repair other functions as well.

The function must return a line that has been read from the file descriptor
